...
def test_square():
    ...
    test_array_border_3_1 = np.array([[x,x,x],
                                      [x,o,x],
                                      [x,x,x]])
    assert_array_equal(test_array_border_3_1, create_square_border_array(size=3,border_width=1))
    test_array_border_6_2 = np.array([[x,x,x,x,x,x],
                                      ...
                                      [x,x,x,x,x,x],
                                      [x,x,x,x,x,x],])
    assert_array_equal(test_array_border_6_2, create_square_border_array(size=6,border_width=2))
